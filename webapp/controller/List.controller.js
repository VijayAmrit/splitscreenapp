sap.ui.define([
    ...
    return BaseController.extend("za.co.spar.products.detail.splitscreenapp.controller.List", {
        ...
        onOpenViewSettings: function (oEvent) {
            ...
            if (!this.byId("viewSettingsDialog")) {
                Fragment.load({
                    ...
                    name: "za.co.spar.products.detail.splitscreenapp.view.ViewSettingsDialog",
                    controller: this
