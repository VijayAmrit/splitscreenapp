		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Products",
									"targetURL": "#zacosparproductsdetailsplitscreenapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zacosparproductsdetailsplitscreenapp-display": {
								"semanticObject": "zacosparproductsdetailsplitscreenapp",
								"action": "display",
								"description": "A Fiori application for Products.",
								"title": "Products",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=za.co.spar.products.detail.splitscreenapp",
									"url": sap.ui.require.toUrl("za/co/spar/products/detail/splitscreenapp")
								}
							}
						}
					}
